         ...
         <tr>
            ...
            <td>
               <div class="btn-group" role="group" aria-label="Basic mixed styles example" align="right">
                  <a href="edit_lapangan.php?nama_lapangan=<?php echo $row["nama_lapangan"]?>"class="btn btn-primar">Edit</a>
                  <a href="hapus_lapangan.php?nama_lapangan=<?php echo $row["nama_lapangan"]?>"class="btn btn-warning">Hapus</a>
               </div>
               <!-- Edit | Terima | Tolak|  -->
            </td>
         </tr>
